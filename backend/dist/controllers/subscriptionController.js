...
exports.checkPremiumFeatures = exports.getSubscriptionPlans = exports.cancelSubscription = exports.updateSubscription = exports.createSubscription = exports.getSubscription = void 0;
...
const checkPremiumFeatures = async (req, res) => {
    try {
        if (!req.user) {
            res.status(401).json({
                success: false,
...
exports.checkPremiumFeatures = checkPremiumFeatures;
